...
function History() {
    ...
    return (
        <Row className="hover:!shadow-lg m-auto my-5 transition-all delay-200 hover:!cursor-pointer border-s-4 border-[#292A71] hover:border-opacity-90 !bg-gray-200 hover:rounded-xl rounded-e-xl p-3 !shadow-md">
            ...
            <p className="pt-3 text-justify">تأسیس شرکت سهامی خاص فولاد آلیاژی مرکزی بافق در تاریخ ۱۴۰۱/۰۵/۰۲ به شماره ثبت ۱۷۰ و شناسه ملی ۱۴۰۱۰۴۴۴۲۴۴ ثبت و امضا ذیل دفاتر تکمیل گردیده که خلاصه آن جهت اطلاع عموم آگهی می‌گردد.<br/>
