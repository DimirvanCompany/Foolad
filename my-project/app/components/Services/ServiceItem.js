function ServiceItem({ icon, title, text }) {
    return (
        <div className="my-3 h-[300px] relative flex flex-col items-center p-12 bg-gray-100 rounded-xl shadow-md">
            ...
            <p className="relative text-[13.5px] text-justify text-gray-600 mt-4" aria-label={text}>{text}</p>
        </div>
    );
}
